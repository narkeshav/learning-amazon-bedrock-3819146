...
#         client=client,
#         model_id="amazon.titan-embed-text-v2:0"  # Updated to use Titan Embed Text v2
#     )
...
# Adding below changes-
    # Add a loading indicator when processing requests.
    # Implement input validation to ensure the prompt is not empty.
    # Consider adding a clear conversation button.
